...
class GradeBook(Base):
    """
    The MIT Learning Modules web service (LMod) always returns a
    response. The returned data structure will contain these items:
    ...
    The Gradebook API returns the ``data`` as a Python data structure,
